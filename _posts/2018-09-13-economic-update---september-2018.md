...
By plotting 19 key economic indicators, the BaR Analysis Grid© clarifies current economic conditions and signals how near the economy is to a recession. The mean of coordinates (MoC) is the average of all plotted points. It indicates the overall health of the economy.  It is designated below with a red square.  If that red square hits the area shown by a light red rectangle, that would indicate the possible beginning of a recession.
